  ...
  ]},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Che cosa cerca Cartesio quando esce dal collegio di La Flèche?',
     ...
     perche:'Aveva studiato tutto e non sapeva distinguere il vero dal falso: il problema non erano le nozioni che mancavano, era che nessuno gli aveva insegnato come si riconosce una nozione vera.'},
    ...
    {tipo:'scelta', testo:'Che cosa prescrive la regola dell\'analisi?',
     ...
     perche:'Un problema intero non si giudica; i suoi pezzi minimi sì. Dividere finché ogni pezzo è così semplice da essere evidente da solo: è il metodo della matematica portato in filosofia.'},
    ...
    {tipo:'scelta', testo:'A che cosa serve l\'ipotesi del genio maligno?',
     ...
     perche:'I sensi ingannano, ma 2+2=4 resiste anche in sogno. Serviva un dubbio che arrivasse anche lì: un ingannatore onnipotente che ci faccia sbagliare mentre contiamo. Estremo apposta — è la prova più dura possibile.'},
    ...
    {tipo:'scelta', testo:'Perché il cogito resiste a ogni dubbio?',
     ...
     perche:'È l\'unico punto in cui dubitare conferma invece di distruggere: nell\'atto stesso di dubitare c\'è qualcuno che dubita. Non è un ragionamento, è un\'evidenza che si autoconvalida.'},
    ...
    {tipo:'scelta', testo:'Che cosa obietta Hobbes al cogito?',
     ...
     perche:'Cartesio passa da «penso» a «sono una cosa che pensa», cioè uno spirito. Hobbes: dal pensare segue che esisto, non di che pasta sono fatto — potrei benissimo essere un corpo che pensa.'},
    ...
    {tipo:'scelta', testo:'Perché Cartesio ha bisogno di dimostrare che Dio esiste?',
     ...
     perche:'Con il solo cogito resterebbe chiuso nella propria mente. Solo un Dio che non inganna garantisce che le idee chiare e distinte corrispondano a qualcosa fuori. Senza Dio, Cartesio è un solipsista.'},
    ...
    {tipo:'scelta', testo:'Da che cosa nasce l\'errore, secondo Cartesio?',
     ...
     perche:'L\'intelletto è limitato, la volontà è infinita: sbagliamo quando affermiamo più di quanto vediamo chiaro. L\'errore quindi è colpa nostra, non di Dio — ed è evitabile sospendendo il giudizio.'},
  ...
  ]},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Perché Spinoza conclude che esiste una sola sostanza?',
     ...
     perche:'Parte dalla definizione di Cartesio e la prende sul serio: sostanza è ciò che esiste da sé. Ma allora un mondo creato, che dipende da Dio, non è sostanza — e restano Dio e nient\'altro.'},
    ...
    {tipo:'scelta', testo:'Che cosa significa la formula «Deus sive Natura»?',
     ...
     perche:'«Sive» vuol dire «ossia», non «oppure». Non sono due cose collegate: sono lo stesso nome per la stessa realtà, guardata come principio o come insieme delle cose.'},
    ...
    {tipo:'scelta', testo:'Che rapporto c\'è fra natura naturante e natura naturata?',
     ...
     perche:'Sono la stessa sostanza vista da due lati: attiva, che produce; e prodotta. La causa non sta fuori dall\'effetto come l\'artigiano fuori dal vaso — sta dentro, come immanente.'},
    ...
    {tipo:'scelta', testo:'Che cosa afferma il parallelismo psico-fisico?',
     ...
     perche:'Risolve il problema che Cartesio aveva lasciato aperto: mente e corpo non interagiscono, perché sono la stessa cosa espressa in due attributi. Non si toccano, corrono insieme.'},
    ...
    {tipo:'scelta', testo:'Che cos\'è il conatus?',
     ...
     perche:'È il motore di tutta l\'etica: prima di ogni scelta morale ogni essere spinge per continuare a essere. Il bene e il male non sono qualità delle cose, sono ciò che aiuta o ostacola quello sforzo.'},
    ...
    {tipo:'scelta', testo:'In che cosa consiste la libertà per Spinoza?',
     ...
     perche:'Non c\'è nessun libero arbitrio: crediamo di essere liberi solo perché conosciamo le nostre voglie e non le loro cause. Liberi si diventa capendo — non facendo eccezione alla necessità, ma sapendo com\'è fatta.'},
    ...
    {tipo:'scelta', testo:'Che cos\'è il terzo genere di conoscenza?',
     ...
     perche:'Dopo l\'immaginazione (i sensi) e la ragione (le leggi generali), c\'è lo sguardo che vede la singola cosa dentro l\'ordine di Dio. È il vertice dell\'Etica, e coincide con l\'amore intellettuale di Dio.'},
  ...
  ]},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Che cosa distingue l\'ordine di Leibniz da quello di Spinoza?',
     ...
     perche:'In Spinoza tutto è necessario e Dio non poteva fare altrimenti. In Leibniz Dio sceglie fra infiniti mondi possibili: l\'ordine resta razionale, ma è voluto — e questo salva la libertà divina.'},
    ...
    {tipo:'scelta', testo:'Che cosa caratterizza le verità di fatto?',
     ...
     perche:'«Cesare passò il Rubicone» è vera, ma il contrario non è assurdo: si può pensare senza contraddizione. Le verità di ragione no — negarle è come negare che il triangolo abbia tre lati.'},
    ...
    {tipo:'scelta', testo:'Che cosa significa che la ragion sufficiente «inclina senza necessitare»?',
     ...
     perche:'È la formula che tiene insieme razionalismo e libertà: c\'è sempre un motivo che spiega la scelta, ma il motivo pesa, non costringe. Senza questa distinzione Leibniz cadrebbe in Spinoza.'},
    ...
    {tipo:'scelta', testo:'Che cos\'è una monade?',
     ...
     perche:'Se la materia si divide all\'infinito, non se ne trova mai il mattone: allora il vero elemento non è materiale. La monade è un punto di forza, non di spazio — «atomo spirituale».'},
    ...
    {tipo:'scelta', testo:'Che cosa sono le «piccole percezioni»?',
     ...
     perche:'Il rumore del mare è fatto di infinite gocce, e nessuna la sentiamo da sola. Leibniz scopre così che la mente contiene molto più di quanto sappia: è un\'anticipazione dell\'inconscio.'},
    ...
    {tipo:'scelta', testo:'Che problema risolve l\'armonia prestabilita?',
     ...
     perche:'È il problema lasciato aperto da Cartesio. Le monadi «non hanno finestre»: nulla entra e nulla esce. Anima e corpo non si toccano — vanno d\'accordo come due orologi regolati insieme all\'origine.'},
    ...
    {tipo:'scelta', testo:'Perché questo è il migliore dei mondi possibili?',
     ...
     perche:'Non vuol dire un mondo senza mali: i beni sono incompatibili fra loro, e Dio massimizza il totale. È la teodicea — e sarà proprio questa la tesi che Voltaire deriderà nel Candide.'},
  ...
  ]},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Che cos\'è il ragionamento per Hobbes?',
     ...
     perche:'«Ragionare è computare»: pensare non è contemplare verità eterne, è manipolare segni. Da qui il materialismo — se il pensiero è calcolo, non serve un\'anima immateriale per farlo.'},
    ...
    {tipo:'scelta', testo:'Di che cosa possiamo avere conoscenza certa?',
     ...
     perche:'Conosciamo davvero solo ciò di cui possediamo la costruzione: le figure perché le tracciamo noi, lo Stato perché lo fondiamo noi. La natura invece l\'ha fatta Dio, e di quella abbiamo solo ipotesi.'},
    ...
    {tipo:'scelta', testo:'Che cosa risponde Hobbes al cogito di Cartesio?',
     ...
     perche:'Concede la premessa e nega la conclusione: che io pensi non dice di che sostanza sono. Per Hobbes ciò che pensa è il corpo — il pensiero è movimento di materia, non attività di uno spirito.'},
    ...
    {tipo:'scelta', testo:'Perché nello stato di natura scoppia la guerra di tutti contro tutti?',
     ...
     perche:'L\'uguaglianza è il problema, non la soluzione: nessuno è tanto forte da essere al sicuro, e il più debole può uccidere il più forte nel sonno. Con risorse scarse, la paura reciproca basta a scatenare tutti.'},
    ...
    {tipo:'scelta', testo:'Che differenza c\'è fra diritto naturale e legge naturale?',
     ...
     perche:'Il diritto è libertà illimitata di fare tutto per sopravvivere — ed è ciò che rende la vita impossibile. La legge è il calcolo razionale che dice di rinunciarvi. Il diritto crea il problema, la legge lo risolve.'},
    ...
    {tipo:'scelta', testo:'Perché per Hobbes il potere sovrano non può essere diviso?',
     ...
     perche:'Un potere diviso è un potere che può entrare in conflitto con sé stesso, e allora manca l\'arbitro: si torna alla guerra civile. La sicurezza si compra solo con un comando ultimo e indiscusso.'},
    ...
    {tipo:'scelta', testo:'Che cosa afferma il giuspositivismo di Hobbes?',
     ...
     perche:'Non c\'è una giustizia scritta nelle cose a cui la legge debba conformarsi: prima della legge non esiste né giusto né ingiusto. È il rovesciamento del diritto naturale classico.'},
  ...
  ]},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Con quale argomento Locke nega le idee innate?',
     ...
     perche:'Se un\'idea fosse innata dovrebbe trovarsi in tutti: ma bambini, popoli lontani e uomini senza istruzione non ne sanno nulla. Cade così il fondamento del razionalismo cartesiano.'},
    ...
    {tipo:'scelta', testo:'Che differenza c\'è fra idee semplici e complesse?',
     ...
     perche:'Sulle semplici la mente è passiva: le riceve e basta, non può inventarne una nuova. Sulle complesse è attiva. È il confine fra ciò che l\'esperienza detta e ciò che il pensiero costruisce.'},
    ...
    {tipo:'scelta', testo:'Quali sono le qualità secondarie dei corpi?',
     ...
     perche:'Il colore non è nella cosa: è l\'effetto che la cosa produce in noi. Le primarie — estensione, figura, movimento — restano anche senza osservatore; le secondarie no.'},
    ...
    {tipo:'scelta', testo:'Che cosa sono le idee generali per Locke?',
     ...
     perche:'Non esistono uomini in generale, esistono uomini singoli: «uomo» è un segno che la mente costruisce astraendo ciò che hanno in comune. Il generale sta nel linguaggio, non nelle cose.'},
    ...
    {tipo:'scelta', testo:'In che cosa lo stato di natura di Locke differisce da quello di Hobbes?',
     ...
     perche:'In Hobbes è guerra; in Locke è già uno stato di diritto, dove la ragione insegna che nessuno deve danneggiare vita, libertà e proprietà altrui. Da questa differenza nasce tutta la distanza politica fra i due.'},
    ...
    {tipo:'scelta', testo:'Che cosa fonda il diritto di proprietà?',
     ...
     perche:'La terra è comune, ma il lavoro è di ciascuno: mescolando il proprio lavoro con una cosa vi si mette qualcosa di sé. È la giustificazione della proprietà che fonderà il liberalismo.'},
    ...
    {tipo:'scelta', testo:'Perché i cittadini di Locke conservano il diritto di resistenza?',
     ...
     perche:'Il patto non trasferisce i diritti, li affida perché siano protetti: se il sovrano li viola, viene meno la ragione stessa del mandato. Il potere è fiduciario, e la fiducia si può ritirare.'},
  ...
  ]},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'A quale scopo Berkeley usa l\'empirismo di Locke?',
     ...
     perche:'È un vescovo, non uno scettico: porta l\'empirismo alle estreme conseguenze proprio per eliminare la materia, che considerava il fondamento dell\'ateismo. Se esistono solo idee e spiriti, Dio è necessario.'},
    ...
    {tipo:'scelta', testo:'Perché Berkeley nega che esistano idee astratte?',
     ...
     perche:'Prova a immaginare «un triangolo» che non sia né equilatero né scaleno: non ci si riesce. Se ogni idea nella mente è particolare, l\'astrazione di Locke è un\'illusione del linguaggio.'},
    ...
    {tipo:'scelta', testo:'Come funzionano allora le idee generali?',
     ...
     perche:'Non c\'è nessuna idea generale: c\'è un\'idea particolare che facciamo lavorare come rappresentante di tutte le simili. Il generale sta nell\'uso del segno, non nel contenuto della mente.'},
    ...
    {tipo:'scelta', testo:'Che cosa afferma la formula «esse est percipi»?',
     ...
     perche:'Nessuna cosa esiste senza essere percepita: togliendo colore, sapore, resistenza, dell\'oggetto non rimane niente. E ciò che continua a percepire quando noi non guardiamo è Dio.'},
    ...
    {tipo:'scelta', testo:'Perché Berkeley respinge la distinzione fra qualità primarie e secondarie?',
     ...
     perche:'Locke aveva reso soggettivi i colori: Berkeley osserva che estensione e figura si percepiscono solo attraverso quei colori. Se cade una, cadono tutte — e con esse la materia.'},
    ...
    {tipo:'scelta', testo:'Come distingue Berkeley le sensazioni dalle fantasie?',
     ...
     perche:'Se tutto è idea, resta il problema di distinguere il reale dall\'immaginario. Le sensazioni non le scegliamo, hanno un ordine costante: reale non vuol dire materiale, vuol dire regolare e non dipendente da noi.'},
    ...
    {tipo:'scelta', testo:'Che cosa sono le leggi naturali, per Berkeley?',
     ...
     perche:'Non forze che agiscono nella materia, ma le regolarità con cui Dio ci fa avere le sensazioni. La scienza resta valida come descrizione dell\'ordine, ma perde ogni pretesa di spiegare cause materiali.'},
  ...
  ]},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Che differenza c\'è fra impressioni e idee?',
     ...
     perche:'Non differiscono per contenuto ma per intensità: l\'idea è la copia sbiadita dell\'impressione. Da qui il criterio che Hume userà come scure — un\'idea senza impressione corrispondente è priva di senso.'},
    ...
    {tipo:'scelta', testo:'Come spiega Hume le idee generali?',
     ...
     perche:'Come Berkeley: un\'idea particolare che l\'abitudine ha legato a una parola, e la parola richiama all\'occorrenza le altre simili. Il generale è un effetto dell\'uso, non un contenuto della mente.'},
    ...
    {tipo:'scelta', testo:'Perché il legame causale non si può conoscere a priori?',
     ...
     perche:'Guardando una palla che ne colpisce un\'altra, nulla nella prima contiene la seconda: potrebbe fermarsi, rimbalzare, sparire. Solo l\'esperienza dice che cosa accade — e l\'esperienza riguarda il passato.'},
    ...
    {tipo:'scelta', testo:'Perché il «congiungimento costante» non basta a fondare la causalità?',
     ...
     perche:'È il problema dell\'induzione: mille casi non fanno una necessità. Per passare da «è sempre stato» a «sarà» servirebbe supporre che la natura sia uniforme, ma questo è proprio ciò che andrebbe provato.'},
    ...
    {tipo:'scelta', testo:'Che cos\'è allora il principio di causalità?',
     ...
     perche:'Non un dato del mondo né una verità di ragione, ma un\'abitudine psicologica: vista mille volte la successione, la mente scivola dall\'una all\'altra e chiama necessità quella propria attesa.'},
    ...
    {tipo:'scelta', testo:'Che cos\'è l\'io, secondo Hume?',
     ...
     perche:'Applica il suo criterio a sé stesso e non trova alcuna impressione di «io», ma solo percezioni che si succedono. Se non c\'è impressione, non c\'è idea: la sostanza-anima crolla come la materia.'},
    ...
    {tipo:'scelta', testo:'Che rapporto c\'è fra ragione e passione nella morale di Hume?',
     ...
     perche:'«La ragione è e deve essere schiava delle passioni.» La ragione calcola i mezzi, ma non dà mai un fine: da un «è» non si ricava un «deve». È la legge di Hume, e vale ancora oggi in etica.'},
