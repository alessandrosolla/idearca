...
},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Qual è l\'obiettivo di Cartesio nel Discorso sul metodo?',
     ...
     perche:'Non aggiungere un piano all\'edificio del sapere, ma rifarne le fondamenta. Se sotto c\'è sabbia non conta quanto è alto: meglio buttare giù tutto e ripartire da una certezza sola.'},
    ...
    {tipo:'scelta', testo:'Quale modello di sapere prende Cartesio come riferimento?',
     ...
     perche:'La matematica è l\'unico sapere dove nessuno litiga: parte da poche evidenze e procede per passi controllabili. Cartesio non ne prende i contenuti, ne prende il modo di procedere.'},
    ...
    {tipo:'scelta', testo:'Che cos\'è il dubbio metodico?',
     ...
     perche:'Non è lo scetticismo, che dubita e si ferma lì. È uno strumento: si dubita apposta di tutto per vedere che cosa resta in piedi. Il dubbio è il mezzo, la certezza è lo scopo.'},
    ...
    {tipo:'scelta', testo:'Che cosa mette in dubbio l\'ipotesi del genio maligno?',
     ...
     perche:'Arriva dove il dubbio sui sensi non arriva: la matematica. Se un ingannatore onnipotente mi fa sbagliare ogni volta che sommo, allora nemmeno 2+2=4 è al sicuro.'},
    ...
    {tipo:'scelta', testo:'Perché il cogito resiste anche al genio maligno?',
     ...
     perche:'L\'inganno ha bisogno di un ingannato. Più il genio maligno mi imbroglia, più conferma che ci sono: è l\'unica cosa che il dubbio non riesce a mangiare perché il dubbio stesso la presuppone.'},
    ...
    {tipo:'scelta', testo:'Qual è il criterio di verità che Cartesio ricava dal cogito?',
     ...
     perche:'Il cogito non serve solo come prima certezza: serve come campione. Guarda perché è certo — è chiaro e distinto — e fa di quella qualità la regola per tutto il resto.'},
    ...
    {tipo:'scelta', testo:'Che funzione ha Dio nel sistema di Cartesio?',
     ...
     perche:'È il ponte fra la mente e il mondo. Un Dio perfetto non può volermi ingannare sistematicamente: quindi ciò che vedo chiaramente è vero davvero e non solo dentro la mia testa.'},
    ...
    {tipo:'scelta', testo:'In quali due sostanze Cartesio divide la realtà creata?',
     ...
     perche:'Pensiero ed estensione non hanno niente in comune: è il dualismo. Da qui nasce il problema che si trascinerà per due secoli — come fanno due sostanze così diverse a toccarsi in un uomo vivo?'},
...
},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Come Hume distingue le impressioni dalle idee?',
     ...
     perche:'Per forza e vivacità: sentire il caldo non è come ricordarselo. Ne segue il metodo — davanti a un concetto oscuro, chiedersi da quale impressione derivi. Se non ce n\'è nessuna, è una parola vuota.'},
    ...
    {tipo:'scelta', testo:'Che cosa cerchiamo, secondo Hume, quando osserviamo una causa e un effetto?',
     ...
     perche:'Cerchiamo il legame necessario e non lo troviamo mai: vediamo che una cosa segue l\'altra, non che debba seguirla. La necessità non è nell\'oggetto, è nell\'occhio abituato.'},
    ...
    {tipo:'scelta', testo:'Da dove nasce allora l\'idea di causalità?',
     ...
     perche:'Dall\'abitudine. È una spiegazione psicologica, non logica: Hume non nega che usiamo la causalità — è indispensabile per vivere — nega che sia dimostrabile.'},
    ...
    {tipo:'scelta', testo:'In che consiste il circolo vizioso dell\'induzione?',
     ...
     perche:'Per giustificare l\'induzione si dovrebbe dire «ha sempre funzionato, quindi funzionerà»: ma è un ragionamento induttivo. Si finisce per fondare l\'induzione su sé stessa.'},
    ...
    {tipo:'scelta', testo:'Che conclusione trae Hume sul metodo scientifico?',
     ...
     perche:'La scienza non perde valore, perde le pretese: le sue leggi sono credenze ben fondate e utilissime, non certezze necessarie. Sarà questa conclusione a svegliare Kant dal «sonno dogmatico».'},
    ...
    {tipo:'scelta', testo:'Che cosa trova Hume quando cerca dentro di sé il proprio io?',
     ...
     perche:'Entra in sé stesso e incontra sempre qualche percezione — caldo, luce, dolore — mai l\'io che le possiede. L\'io come sostanza è un\'idea senza impressione, quindi da eliminare.'},
    ...
    {tipo:'scelta', testo:'Che cosa produce allora l\'unità dell\'io, secondo Hume?',
     ...
     perche:'L\'immaginazione: la somiglianza e la continuità fra percezioni ci fanno credere a un soggetto unico, come una nave rifatta pezzo per pezzo continua a chiamarsi la stessa nave.'},
    ...
    {tipo:'scelta', testo:'Come Hume divide tutte le proposizioni?',
     ...
     perche:'Le relazioni fra idee sono necessarie ma non dicono nulla sul mondo; i dati di fatto dicono del mondo ma non sono necessari. Non esiste una terza classe — ed è il colpo mortale alla metafisica.'},
...
},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Che cosa vuol dire che Spinoza è monista?',
     ...
     perche:'Monismo: una sola sostanza. Cade la frattura fra creatore e creato che regge tutta la teologia — Dio non è l\'artefice del mondo, è il mondo colto nella sua necessità.'},
    ...
    {tipo:'scelta', testo:'Che cosa vuol dire che la sostanza è «increata»?',
     ...
     perche:'Se qualcosa l\'avesse prodotta dipenderebbe da quel qualcosa, e allora non sarebbe sostanza. Causa sui: la sua essenza implica l\'esistenza, cioè non può non esserci.'},
    ...
    {tipo:'scelta', testo:'In che senso l\'uomo obbedisce «alle stesse leggi della geometria»?',
     ...
     perche:'L\'Etica è scritta more geometrico, con definizioni e teoremi, e non per vezzo: se l\'odio e la gelosia seguono leggi necessarie come i triangoli, allora si possono studiare senza indignarsi.'},
    ...
    {tipo:'scelta', testo:'Che cos\'è il conatus, nella formula di Spinoza?',
     ...
     perche:'«Ogni cosa si sforza di perseverare nel proprio essere.» Non è un istinto in più fra gli altri: è ciò che una cosa è. Da questo unico sforzo Spinoza deduce tutte le passioni.'},
    ...
    {tipo:'scelta', testo:'Perché Spinoza dice che l\'uomo non è «un dominio dentro un altro dominio»?',
     ...
     perche:'È la frase che rompe con tutta la tradizione: l\'uomo non è un\'isola di libertà dentro la natura necessaria. Nessuna eccezione — e quindi le sue passioni si studiano come si studia il tempo atmosferico.'},
    ...
    {tipo:'scelta', testo:'Che rapporto ha la libertà con la necessità, in Spinoza?',
     ...
     perche:'La necessità non è il contrario della libertà: è il suo materiale. Una pietra che cadesse pensando sarebbe convinta di volerlo — noi siamo quella pietra, meno l\'ignoranza, quando capiamo perché cadiamo.'},
    ...
    {tipo:'scelta', testo:'Che cosa succede a una passione quando la comprendiamo?',
     ...
     perche:'Una passione è un\'idea confusa: la subiamo perché non ne vediamo la causa. Appena la vediamo diventa idea adeguata, e da passiva diventa nostra. È tutta qui la terapia dell\'Etica.'},
    ...
    {tipo:'scelta', testo:'Perché la formula «Deus sive Natura» era scandalosa?',
     ...
     perche:'Un Dio che coincide con la natura non crea per scelta, non ascolta, non premia e non punisce: restano fuori la provvidenza, il miracolo e il giudizio. Per questo Spinoza fu accusato di ateismo da tutte le confessioni insieme.'},
...
},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Che cosa oppone Leibniz all\'unità monistica di Spinoza?',
     ...
     perche:'Spinoza dissolve gli individui in un\'unica sostanza. Leibniz fa il contrario: le sostanze sono infinite, ciascuna irripetibile. Salva così esattamente ciò che Spinoza sacrifica, l\'individuo.'},
    ...
    {tipo:'scelta', testo:'Che cosa afferma il principio degli indiscernibili?',
     ...
     perche:'Se due cose avessero tutte le proprietà uguali sarebbero la stessa cosa: due foglie identiche non esistono. Ogni monade quindi differisce da ogni altra — l\'individualità è una legge, non un caso.'},
    ...
    {tipo:'scelta', testo:'Qual è l\'attività di base comune a tutte le monadi?',
     ...
     perche:'Percezione non vuol dire coscienza: anche la monade più bassa rappresenta l\'universo intero, solo in modo confuso. È il grado di chiarezza a fare la differenza fra un sasso e un uomo.'},
    ...
    {tipo:'scelta', testo:'Che cos\'è l\'appetizione?',
     ...
     perche:'Se la monade è chiusa, il cambiamento deve venirle da dentro: l\'appetizione è quella spinta interna. Senza di essa le monadi sarebbero congelate in un\'unica percezione per sempre.'},
    ...
    {tipo:'scelta', testo:'Che cosa distingue le monadi superiori?',
     ...
     perche:'Percepire lo fanno tutte; accorgersi di percepire no. L\'appercezione è la coscienza, ed è ciò che separa l\'anima animale dallo spirito capace di verità necessarie.'},
    ...
    {tipo:'scelta', testo:'Se le monadi non comunicano, come si spiega l\'accordo fra mente e corpo?',
     ...
     perche:'Dio ha regolato all\'origine ogni monade in modo che i loro stati coincidano. Non c\'è influsso, c\'è corrispondenza: la mano si muove quando lo voglio, ma non perché lo voglio.'},
    ...
    {tipo:'scelta', testo:'Che rapporto c\'è fra ogni monade e l\'universo intero?',
     ...
     perche:'Ogni monade è uno specchio vivente del tutto, ma da un punto di vista solo. La stessa città vista da mille angoli dà mille città: l\'universo è uno, le prospettive infinite.'},
    ...
    {tipo:'scelta', testo:'Perché la matematica infinitesimale interessa Leibniz anche come filosofo?',
     ...
     perche:'Il calcolo che ha inventato tratta grandezze che si dividono senza fine. È la stessa struttura che vede nella realtà: nessun ultimo pezzo materiale, e quindi elementi non estesi.'},
...
},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Come descrive Hobbes il ragionamento?',
     ...
     perche:'Somme e sottrazioni di nomi: il pensiero è un\'operazione meccanica, non l\'intuizione di essenze. È la premessa di tutto il resto — un uomo così concepito è una macchina, e lo Stato pure.'},
    ...
    {tipo:'scelta', testo:'Come divide Hobbes la filosofia?',
     ...
     perche:'I corpi naturali li ha fatti Dio, quelli artificiali li facciamo noi: lo Stato è un corpo artificiale. La divisione non è organizzativa, è epistemologica — dice dove possiamo avere certezza.'},
    ...
    {tipo:'scelta', testo:'Perché per Hobbes non esiste un sommo bene?',
     ...
     perche:'Il desiderio soddisfatto ne apre un altro: la felicità non è arrivare, è continuare a muoversi. Cade così tutta l\'etica classica, che cercava il fine ultimo dell\'uomo.'},
    ...
    {tipo:'scelta', testo:'Che cosa dice il determinismo di Hobbes sulle azioni umane?',
     ...
     perche:'Se tutto è corpo in movimento, anche la volontà lo è: l\'ultimo desiderio prima dell\'azione si chiama scelta, ma è l\'effetto di cause precedenti. Libertà per Hobbes vuol dire solo assenza di ostacoli esterni.'},
    ...
    {tipo:'scelta', testo:'Perché nello stato di natura non esiste il giusto né l\'ingiusto?',
     ...
     perche:'Giusto e ingiusto sono relativi a una legge, e la legge nasce con il sovrano. Prima ci sono solo forza e paura: non un mondo immorale, un mondo dove la morale non ha ancora senso.'},
    ...
    {tipo:'scelta', testo:'Come descrive Hobbes la vita nello stato di natura?',
     ...
     perche:'La formula del Leviatano: «solitaria, misera, sgradevole, brutale e breve». Non è un ritratto storico ma un esperimento mentale — che cosa resterebbe togliendo lo Stato.'},
    ...
    {tipo:'scelta', testo:'Perché il patto sociale, per Hobbes, moltiplica la potenza?',
     ...
     perche:'Cento uomini che si temono valgono meno di zero; cento uomini con una volontà sola valgono più di cento. L\'unione non somma le forze, le rende utilizzabili.'},
    ...
    {tipo:'scelta', testo:'Che metodo assegna Hobbes alla filosofia civile?',
     ...
     perche:'Lo stesso di Galileo e della geometria: si scompone lo Stato nei suoi elementi — gli individui e le loro passioni — e poi si ricostruisce deducendo. La politica diventa una scienza dimostrativa.'},
...
},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Su che cosa si dividono Cartesio e Locke sull\'origine delle idee?',
     ...
     perche:'È il punto di rottura fra razionalismo ed empirismo: per Cartesio la mente possiede già i propri contenuti fondamentali, per Locke non possiede nulla che non le sia arrivato dai sensi.'},
    ...
    {tipo:'scelta', testo:'Che cosa vuol dire che la mente è una «tabula rasa»?',
     ...
     perche:'L\'immagine è antica ma la conseguenza è nuova: se la mente nasce vuota, tutto ciò che siamo viene dall\'esperienza — e quindi dall\'educazione e dall\'ambiente. È la premessa filosofica dell\'Illuminismo.'},
    ...
    {tipo:'scelta', testo:'Che cosa può e che cosa non può fare la mente con le idee semplici?',
     ...
     perche:'La mente combina, separa, confronta: ma non può creare dal nulla un\'idea semplice nuova, come non si può far immaginare un colore a chi è cieco dalla nascita. Il materiale lo detta l\'esperienza.'},
    ...
    {tipo:'scelta', testo:'Che cosa sono i «modi», fra le idee complesse?',
     ...
     perche:'Sono idee che non stanno in piedi da sole: la gratitudine esiste in una persona grata, il triangolo in una figura. Si distinguono dalle sostanze, che invece pensiamo come autonome.'},
    ...
    {tipo:'scelta', testo:'Che cos\'è, per Locke, il criterio di verità?',
     ...
     perche:'Non l\'evidenza interna alla mente, come in Cartesio, ma il confronto con l\'esperienza — esterna attraverso i sensi, interna attraverso la riflessione. La verifica prende il posto dell\'intuizione.'},
    ...
    {tipo:'scelta', testo:'Su che cosa si fonda, per Locke, l\'identità della persona?',
     ...
     perche:'Non sul corpo, che cambia, né su un\'anima-sostanza che non percepiamo: sulla continuità della coscienza e della memoria. Sono la stessa persona di ieri perché mi ricordo di esserlo stato.'},
    ...
    {tipo:'scelta', testo:'Che cosa cambia nel passaggio dallo stato di natura allo Stato liberale?',
     ...
     perche:'In Hobbes il patto crea i diritti; in Locke li trova già esistenti e si limita a garantirli. Lo Stato non è il padrone dei diritti, ne è il custode — e questa è la differenza fra assolutismo e liberalismo.'},
    ...
    {tipo:'scelta', testo:'Su che cosa si fonda l\'autorità del sovrano per Locke?',
     ...
     perche:'Sul consenso di chi è governato, non su un\'investitura dall\'alto. Toglie così ogni base al diritto divino dei re: il potere nasce dal basso, ed è per questo revocabile.'},
...
},
{
  ...
  domande: [
    ...
    {tipo:'scelta', testo:'Quali sono le due colonne della dottrina di Berkeley?',
     ...
     perche:'Vanno insieme: il nominalismo elimina le idee astratte, e «materia» è appunto la più astratta di tutte. Demolita l\'astrazione, l\'immaterialismo segue da sé.'},
    ...
    {tipo:'scelta', testo:'Che cosa nega il nominalismo radicale di Berkeley?',
     ...
     perche:'Nella mente ci sono solo idee particolari. È il colpo che prepara tutto il resto: senza astrazione non si può nemmeno formulare l\'idea di una sostanza materiale dietro le qualità.'},
    ...
    {tipo:'scelta', testo:'Se non esistono idee astratte, come si parla di «triangolo» in generale?',
     ...
     perche:'Il geometra disegna un triangolo preciso e ragiona ignorando ciò che ha di particolare. La generalità è un modo di usare un\'immagine, non un\'immagine speciale.'},
    ...
    {tipo:'scelta', testo:'Quali qualità erano considerate «primarie» nella tradizione?',
     ...
     perche:'Da Galileo a Locke: estensione, figura, movimento, numero — le qualità misurabili, ritenute nella cosa. È su questa distinzione che si regge l\'idea moderna di materia.'},
    ...
    {tipo:'scelta', testo:'Con quale argomento Berkeley demolisce questa distinzione?',
     ...
     perche:'Prova a togliere il colore da una superficie e a lasciarne l\'estensione: non resta niente da percepire. Le primarie non si danno mai separate dalle secondarie, quindi hanno lo stesso statuto.'},
    ...
    {tipo:'scelta', testo:'Che cosa diventa la materia, nella visione di Berkeley?',
     ...
     perche:'Un sostrato che nessuno ha mai percepito e che non serve a spiegare nulla: un\'astrazione vuota. Non è un errore di misura, è un concetto senza contenuto.'},
    ...
    {tipo:'scelta', testo:'Che cos\'è allora un oggetto fisico?',
     ...
     perche:'Una mela è la somma di rosso, tondo, dolce, sodo: un fascio di idee che ricorrono insieme. Il nome sta per il gruppo, non per una cosa nascosta sotto le qualità.'},
    ...
    {tipo:'scelta', testo:'Dove esistono, per Berkeley, tutte le qualità?',
     ...
     perche:'Solo nella mente. E poiché il mondo non sparisce quando chiudiamo gli occhi, dev\'esserci una mente che percepisce sempre: l\'immaterialismo sfocia direttamente nella prova di Dio.'},
